class Imovel:
    def __init__(self, end, preco):
        self.endereco = end
        self.preco = int(preco)

class ImovelNovo(Imovel):
    def __init__(self, end, preco, adicional):
        super().__init__(end, preco)
        self.adicional = int(adicional)
    
    def calcular_preco(self):
        return self.preco - self.adicional

class ImovelVelho(Imovel):
    def __init__(self, end, preco, desconto):
        super().__init__(end, preco)
